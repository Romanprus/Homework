...
@pytest.mark.smoke
def test_reset_password(open_forgot_pass_window):
    reset = open_forgot_pass_window
    reset = open_forgot_pass_window.reset_password("test@gmail.com")
...
@pytest.mark.smoke
def test_return_to_login_after_password_reset(open_forgot_pass_window):
    reset = open_forgot_pass_window
    reset = open_forgot_pass_window.reset_password("test@gmail.com").back_to_sign_in_screen()
